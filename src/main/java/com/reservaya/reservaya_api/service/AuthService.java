...
public class AuthService {
  ...
  public User register(User user) {
    ...
    // Asigna ADMIN al primer usuario, USER a los demás
  ...
  // --- MÉTODO CORREGIDO (SIN TRY-CATCH) ---
  public AuthResponse login(LoginRequest request) {
    // Dejamos que authenticationManager valide. Si falla, lanzará una excepción
    // que será capturada por nuestro GlobalExceptionHandler.
